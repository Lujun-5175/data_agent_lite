...
class AppSettings:
    ...
    agent_max_total_steps: int = _get_int("AGENT_MAX_TOTAL_STEPS", 36)
    agent_max_same_tool_steps: int = _get_int("AGENT_MAX_SAME_TOOL_STEPS", 15)
    agent_max_no_progress_steps: int = _get_int("AGENT_MAX_NO_PROGRESS_STEPS", 12)
    agent_simple_mode_recursion_limit: int = _get_int("AGENT_SIMPLE_MODE_RECURSION_LIMIT", 36)
    agent_default_recursion_limit: int = _get_int("AGENT_DEFAULT_RECURSION_LIMIT", 36)

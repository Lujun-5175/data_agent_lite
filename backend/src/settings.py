...
class AppSettings:
    ...
    agent_max_total_steps: int = _get_int("AGENT_MAX_TOTAL_STEPS", 18)
    agent_max_same_tool_steps: int = _get_int("AGENT_MAX_SAME_TOOL_STEPS", 5)
    agent_max_no_progress_steps: int = _get_int("AGENT_MAX_NO_PROGRESS_STEPS", 4)
    agent_simple_mode_recursion_limit: int = _get_int("AGENT_SIMPLE_MODE_RECURSION_LIMIT", 8)
    agent_default_recursion_limit: int = _get_int("AGENT_DEFAULT_RECURSION_LIMIT", 18)
